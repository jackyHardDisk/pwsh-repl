@{
    ...
    FunctionsToExport = @(
        ...
        'Get-DevRunCacheList',
        'Invoke-WithTimeout',
        # Background process analysis (process management now in C# SessionManager)
        'Get-BackgroundData',
        # Transform
        'Format-Count',
        'Group-By',
        ...
        # Meta (pattern learning, discovery)
        'Find-ProjectTools',
        'Set-Pattern',
        'Get-Patterns',
        'Test-Pattern',
...
Background Process Analysis (1 function):
- Get-BackgroundData (process management moved to C# SessionManager)
...
- Auto-loads before AgentBlocks (RequiredModules dependency)
