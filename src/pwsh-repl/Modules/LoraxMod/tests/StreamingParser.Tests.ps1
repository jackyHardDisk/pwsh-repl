...
Describe "Invoke-LoraxStreamQuery - Parse Command" {
    BeforeEach {
        Start-LoraxStreamParser -SessionId 'parse_tests' -ErrorAction SilentlyContinue | Out-Null
    }

    AfterEach {
        Stop-LoraxStreamParser -SessionId 'parse_tests' -ErrorAction SilentlyContinue | Out-Null
    }
...
Describe "Invoke-LoraxStreamQuery - Query Command" {
    BeforeEach {
        Start-LoraxStreamParser -SessionId 'query_tests' -ErrorAction SilentlyContinue | Out-Null
    }

    AfterEach {
        Stop-LoraxStreamParser -SessionId 'query_tests' -ErrorAction SilentlyContinue | Out-Null
    }

    It "Should execute tree-sitter query successfully" {
        $query = '(function_declarator declarator: (identifier) @func)'
    ...
    It "Should require Query parameter for query command" {
        $errorOutput = Invoke-LoraxStreamQuery -SessionId 'query_tests' -File $script:SampleC -Command query -ErrorAction SilentlyContinue -ErrorVariable capturedError 2>&1
        $capturedError.Count -gt 0 | Should Be $true
        $capturedError[0].Exception.Message -match 'Query' | Should Be $true
    }
...
Describe "Invoke-LoraxStreamQuery - Ping Command" {
    BeforeEach {
        Start-LoraxStreamParser -SessionId 'ping_tests' -ErrorAction SilentlyContinue | Out-Null
    }

    AfterEach {
        Stop-LoraxStreamParser -SessionId 'ping_tests' -ErrorAction SilentlyContinue | Out-Null
    }
...
Describe "Pipeline Integration" {
    BeforeEach {
        Start-LoraxStreamParser -SessionId 'pipeline_tests' -ErrorAction SilentlyContinue | Out-Null
    }

    AfterEach {
        Stop-LoraxStreamParser -SessionId 'pipeline_tests' -ErrorAction SilentlyContinue | Out-Null
    }
...
Describe "Error Recovery" {
    BeforeEach {
        Start-LoraxStreamParser -SessionId 'error_tests' -ErrorAction SilentlyContinue | Out-Null
    }

    AfterEach {
        Stop-LoraxStreamParser -SessionId 'error_tests' -ErrorAction SilentlyContinue | Out-Null
    }
...
Describe "JSON Protocol Compliance" {
    BeforeEach {
        Start-LoraxStreamParser -SessionId 'protocol_tests' -ErrorAction SilentlyContinue | Out-Null
    }

    AfterEach {
        Stop-LoraxStreamParser -SessionId 'protocol_tests' -ErrorAction SilentlyContinue | Out-Null
    }
    ...
    It "Should include stats in successful responses" {
        ...
        $result.stats.filesProcessed -ge 0 | Should Be $true
    }
}
